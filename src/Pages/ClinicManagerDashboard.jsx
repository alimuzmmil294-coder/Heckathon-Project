  ...
  return (
    <div className="flex ">
      ...
      <div className="flex-1 p-5">
        <h1 className="text-gray-400">Clinic Manager Dashboard</h1>
        ...
        <section className="p-5 flex gap-6 mt-5 ">
          <div className="w-[48%] cursor-pointer border border-gray-200 p-7 rounded-md hover:scale-102  transition-all duration-400">
            <p className="font-bold"> View Appointments</p>
            <p className="text-gray-500">
              Today's Schedule and upcoming visits
            </p>
          </div>
          <div className="w-[48%] cursor-pointer border border-gray-200 rounded-md hover:scale-102 p-7 transition-all duration-400">
